...
class simple_MLP(nn.Module):
    def __init__(self,dims):
        ...
        # Ensure different initialisation for each classifier in the ensemble
        #############################
...
# MLP Ensemble Classifier for SAINTENS
####################################################
class EnsembleMLP(nn.Module):
    def __init__(self, num_mlps, input_dim, hidden_dim):
        ...
        for i in range(self.num_mlps):
            self.mlps.append(simple_MLP([input_dim,hidden_dim,2]))
